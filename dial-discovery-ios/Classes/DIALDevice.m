...
NSString* const kDIALDevice_DeviceDescKey              = @"DeviceDescription";
NSString* const kDIALDevice_FriendlyNameKey            = @"friendlyName";
NSString* const kDIALDevice_ManufacturerKey            = @"manufacturer";
NSString* const kDIALDevice_ModelDescKey               = @"modelDescription";
NSString* const kDIALDevice_ModelNameKey               = @"modelName";
NSString* const kDIALDevice_ModelNumberKey             = @"modelNumber";
NSString* const kDIALDevice_SerialNumberKey            = @"serialNumber";
NSString* const kDIALDevice_UDNKey                     = @"UDN";
NSString* const kDIALDevice_PresentationURLKey         = @"presentationURL";
...
- (id)initWithDictionary:(NSDictionary *) dict{
    ...
    if (self) {
        ...
        NSDictionary *deviceDesc = [dict objectForKey:kDIALDevice_DeviceDescKey];
        _friendlyName = [deviceDesc objectForKey:kDIALDevice_FriendlyNameKey];
        _manufacturer = [deviceDesc objectForKey:kDIALDevice_ManufacturerKey];
        _modelDesc = [deviceDesc objectForKey:kDIALDevice_ModelDescKey];
        _modelName = [deviceDesc objectForKey:kDIALDevice_ModelNameKey];
        _modelNumber = [deviceDesc objectForKey:kDIALDevice_ModelNumberKey];
        _serialNumber = [deviceDesc objectForKey:kDIALDevice_SerialNumberKey];
        _UDN = [deviceDesc objectForKey:kDIALDevice_UDNKey];
        _presentationURL = [deviceDesc objectForKey:kDIALDevice_PresentationURLKey];
