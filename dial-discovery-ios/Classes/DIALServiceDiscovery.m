...
- (void) start{
    ...
    NSTimeInterval t = [[NSNumber numberWithUnsignedInteger:kDIAL_APP_DISCOVERY_TIMEOUT_SECS] doubleValue];
...
- (NSArray*) getDevicesJSON
{
    ...
    for (DIALDevice *d in discoveredDevicesList)
    {
        json = [json stringByAppendingString:[d description]];
