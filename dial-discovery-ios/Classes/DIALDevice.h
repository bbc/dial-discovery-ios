...
FOUNDATION_EXPORT NSString* const kDIALDevice_DeviceDescKey ;
FOUNDATION_EXPORT NSString* const kDIALDevice_FriendlyNameKey ;
FOUNDATION_EXPORT NSString* const kDIALDevice_ManufacturerKey ;
FOUNDATION_EXPORT NSString* const kDIALDevice_ModelDescKey ;
FOUNDATION_EXPORT NSString* const kDIALDevice_ModelNameKey ;
FOUNDATION_EXPORT NSString* const kDIALDevice_ModelNumberKey ;
FOUNDATION_EXPORT NSString* const kDIALDevice_SerialNumberKey ;
FOUNDATION_EXPORT NSString* const kDIALDevice_UDNKey ;
FOUNDATION_EXPORT NSString* const kDIALDevice_PresentationURLKey ;
 ...
 */
@interface DIALDevice : JSONModel <NSCopying>
